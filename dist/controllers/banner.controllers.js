...
export const createBanner = asyncHandler(async (req, res) => {
    ...
    const { title, imageUrl, linkUrl, position, sortOrder, isActive } = validation.data;
...
export const updateBanner = asyncHandler(async (req, res) => {
    ...
    const { bannerId, title, imageUrl, position, linkUrl, isActive, sortOrder, } = validation.data;
