...
export type GetShippingAddressAggregateType<T extends ShippingAddressAggregateArgs> = {
    [P in keyof T & keyof AggregateShippingAddress]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateShippingAddress[P]> : Prisma.GetScalarType<T[P], AggregateShippingAddress[P]>;
};
...
export type ShippingAddressOrderByWithRelationInput = {
    ...
    _relevance?: Prisma.ShippingAddressOrderByRelevanceInput;
};
...
export type ShippingAddressOrderByRelevanceInput = {
    fields: Prisma.ShippingAddressOrderByRelevanceFieldEnum | Prisma.ShippingAddressOrderByRelevanceFieldEnum[];
...
export type ShippingAddressOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "address" | "city" | "postalCode" | "phone" | "fullName" | "orderId", ExtArgs["result"]["shippingAddress"]>;
...
export interface ShippingAddressDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['ShippingAddress'];
        meta: {
            name: 'ShippingAddress';
        };
    };
     ...
     * })
    **/
    count<T extends ShippingAddressCountArgs>(args?: Prisma.Subset<T, ShippingAddressCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ShippingAddressCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ShippingAddressGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
